...
export default function ContactPage(): JSX.Element {
  return (
    <>
      ...
      {/* Content Section */}
      <section className="earth-surface py-16">
            ...
            <div className="lg:col-span-4 space-y-6 lg:-mt-24">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-chrome">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-earth-200 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-earth-900 mb-1">Location</h3>
                    <address className="not-italic text-earth-700 text-sm leading-relaxed">
              ...
              {/* Facebook Card */}
              <div className="hay-accent rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-earth-900" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold text-earth-900 mb-1">Follow Us</h3>
                    <a
                      href={siteConfig.facebookUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-earth-800/80 text-sm hover:text-earth-900 transition-colors inline-flex items-center gap-1"
                    >
                      Facebook
