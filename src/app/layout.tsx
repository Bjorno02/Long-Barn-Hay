...
import { RelocationAnnouncement } from '@/components/ui';
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/photos/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
      { url: '/photos/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
    ],
